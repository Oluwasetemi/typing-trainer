...
type SelectProps = { className?: string; ref?: React.Ref<HTMLSelectElement> } & Omit<Headless.SelectProps, 'as' | 'className'>;

export function Select({ ref, className, multiple, ...props }: SelectProps) {
  return (
    <span
      data-slot="control"
      className={clsx([
