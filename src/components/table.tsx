...
export function Table({
  ...
  const tableContext = useMemo(() => ({ bleed, dense, grid, striped }), [bleed, dense, grid, striped]);

  return (
    <TableContext value={tableContext as React.ContextType<typeof TableContext>}>
...
export function TableRow({
  ...
  return (
    <TableRowContext value={rowContext as React.ContextType<typeof TableRowContext>}>
      <tr
        {...props}
        className={clsx(
          className,
