...
export function BadgeButton({
  ...
  return 'href' in props
    ? (
        <Link {...(props as React.ComponentPropsWithRef<typeof Link>)} className={classes} ref={ref as React.Ref<HTMLAnchorElement>}>
          <TouchTarget>
    ...
    : (
        <Headless.Button {...(props as Headless.ButtonProps)} className={classes} ref={ref as React.Ref<HTMLButtonElement>}>
          <TouchTarget>
            <Badge color={color}>{children}</Badge>
          </TouchTarget>
        </Headless.Button>
